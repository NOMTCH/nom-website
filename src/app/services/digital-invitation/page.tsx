...
export const metadata: Metadata = {
  title: "Digital Invitations — NOM Studio",
  description: "Bespoke animated digital invitations by NOM Studio.",
};
    ...
    <div className="min-h-screen bg-bg pt-32 pb-20">
      <div className="mx-auto max-w-[1600px] px-6 md:px-12 lg:px-20">
        ...
        <div className="flex items-center gap-2 text-xs font-mono text-neutral/40 mb-12">
          ...
          <span>/</span>
          <span className="text-neutral/70">Digital Invitations</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24">
          <div>
            ...
            <h1 className="font-display text-6xl md:text-8xl text-white uppercase tracking-wide leading-[0.85] mb-8">
              Digital<br /><span className="text-accent">Invitations</span>
            </h1>
        ...
        {/* Use Cases */}
        <div className="mb-16">
          <h2 className="font-display text-4xl text-white uppercase mb-8">Perfect For</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["Weddings", "Corporate Events", "Product Launches", "Birthday Parties", "Galas & Galas", "Brand Activations", "Graduations", "Private Dinners"].map((use) => (
              <div key={use} className="p-4 border border-white/5 hover:border-accent/20 transition-colors text-center">
                <span className="text-neutral/60 text-sm font-body">{use}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center border-t border-white/10 pt-16">
          <p className="text-neutral/60 text-lg mb-8">Make your event unforgettable from the first impression.</p>
