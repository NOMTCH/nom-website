...
export const metadata: Metadata = {
  title: "Web Design — NOM Studio",
  description: "Modern, responsive websites and digital experiences by NOM Studio.",
};
    ...
    <div className="min-h-screen bg-bg pt-32 pb-20">
      <div className="mx-auto max-w-[1600px] px-6 md:px-12 lg:px-20">
        ...
        <div className="flex items-center gap-2 text-xs font-mono text-neutral/40 mb-12">
          ...
          <span>/</span>
          <span className="text-neutral/70">Web Design</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24">
          <div>
            ...
            <h1 className="font-display text-7xl md:text-9xl text-white uppercase tracking-wide leading-[0.85] mb-8">
              Web<br /><span className="text-accent">Design</span>
            </h1>
        ...
        {/* Tech Stack Display */}
        <div className="mb-16">
          <h2 className="font-display text-4xl text-white uppercase mb-8">Tech Stack</h2>
          <div className="flex flex-wrap gap-3">
            {["Next.js", "React", "TypeScript", "Tailwind CSS", "GSAP", "Framer Motion", "Figma", "Webflow", "WordPress"].map((tech) => (
              <span key={tech} className="px-4 py-2 border border-white/10 text-neutral/60 text-sm font-mono hover:border-accent hover:text-accent transition-all">
                {tech}
              </span>
            ))}
          </div>
        ...
        <div className="text-center border-t border-white/10 pt-16">
          <p className="text-neutral/60 text-lg mb-8">Ready to build your digital presence?</p>
